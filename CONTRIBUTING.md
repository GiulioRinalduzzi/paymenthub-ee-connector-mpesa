# Contributing to paymenthub-ee-connector-mpesa

Thank you for your interest in contributing to the paymenthub-ee-connector-mpesa! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-connector-mpesa/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-connector-mpesa) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-connector-mpesa.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-connector-mpesa.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-connector-mpesa.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-connector-mpesa.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mpesa.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mpesa.git (push)
```
